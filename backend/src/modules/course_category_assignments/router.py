...
@router.post("/")
async def add_course_category_assignment(assignment: CourseCategoryAssignment):
...
async def update_course_category_assignment_by_id(assignment_id: int, assignment_update: CourseCategoryAssignmentUpdate):
...
async def delete_course_category_assignment_by_id(assignment_id: int):
