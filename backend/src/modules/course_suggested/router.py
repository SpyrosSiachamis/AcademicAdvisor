...
@router.post("/")
async def add_course_suggested(suggested: CourseSuggested):
...
async def update_course_suggested_by_id(suggested_id: int, suggested_update: CourseSuggestedUpdate):
...
async def delete_course_suggested_by_id(suggested_id: int):
