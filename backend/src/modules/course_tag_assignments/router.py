...
@router.post("/")
async def add_course_tag_assignment(assignment: CourseTagAssignment):
...
async def update_course_tag_assignment_by_id(assignment_id: int, assignment_update: CourseTagAssignmentUpdate):
...
async def delete_course_tag_assignment_by_id(assignment_id: int):
